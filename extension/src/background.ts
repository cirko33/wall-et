// Background service worker for the Sepolia ETH Wallet extension

// Listen for extension installation
chrome.runtime.onInstalled.addListener((details) => {
    if (details.reason === 'install') {
        console.log('Sepolia ETH Wallet extension installed');
...
async function handleSendTransaction(transactionData: any, sendResponse: (response: any) => void) {
    try {
...
async function handleGetBalance(address: string, sendResponse: (response: any) => void) {
    try {
...
chrome.runtime.onStartup.addListener(() => {
    console.log('Sepolia ETH Wallet extension started');
});

// Handle extension shutdown
chrome.runtime.onSuspend.addListener(() => {
    console.log('Sepolia ETH Wallet extension suspended');
}); 